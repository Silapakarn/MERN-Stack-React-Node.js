...
public class ProductServiceImpl implements ProductService{
	...
	ProductServiceImpl(StorageService storageService, ProductRepository productRepository) {
		storageService2 = storageService;
	...
	@Override
	public Product createProductById(ProdectRequest productRequest) {
	...
	@Override
	public Product updateProductById(ProdectRequest productRequest, Long id) {
		String fileName = storageService.store(productRequest.getImage());
